...
public class Aplicacion {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for(int a=0; a<10_000_000; a++) {
			...
			//Aqui también sale de su ámbito la variable 'e', pero la instancia no es
			//recolectada por el GC porque el comparador tiene una referencia a ella!!!!
			
			//Si examinamos la VM con el VisualVM comprobamos que al final tenemos
			//-10M de comparadores, que era lo esperado
			//-10M de objetos del tipo 'Ejemplo' !!!!			
		}	
